...
def build_system_prompt(course_name: str) -> str:
    ...
    return (
        ...
        f"- For off-topic questions (movies, sports, personal questions, current events, etc.), politely redirect: 'I'm focused on helping with your studies in {course_name}. Is there something from the course materials I can explain or help clarify?'\n"
