...
from app.models.chat import Chat, ChatPublic, ChatCreate
...
async def generate_chat_response(
    ...
    try:
      ...
      completion = await async_openai_client.chat.completions.create(
          model="gpt-4",
          messages=[
              {"role": "system", "content": "You are a helpful tutor. Use the provided context to answer the question. If the context doesn't contain relevant information, say so politely."},
