...
from app.schemas.public import DifficultyLevel, QuizChoice, QuizPublic, QuizzesPublic

router = APIRouter(prefix="/quizzes", tags=["quizzes"])

@router.get("/{course_id}", response_model=QuizzesPublic)
def list_quizzes(course_id: str, session: SessionDep, current_user: CurrentUser, difficulty: DifficultyLevel = DifficultyLevel.EASY,):
    """
