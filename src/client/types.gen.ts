...
export type PutV1UsersByUserIdWaitlistsByWaitlistIdData = {
    body?: {
        tags?: Array<string>;
    };
    path: {
...
export type PutV1UsersByUserIdWaitlistsByWaitlistIdErrors = {
    /**
     * Unauthorized
     */
    401: {
...
export type PutV1UsersByUserIdWaitlistsByWaitlistIdError = PutV1UsersByUserIdWaitlistsByWaitlistIdErrors[keyof PutV1UsersByUserIdWaitlistsByWaitlistIdErrors];

export type PutV1UsersByUserIdWaitlistsByWaitlistIdResponses = {
    /**
     * OK
     */
    200: Waitlist;
...
export type PutV1UsersByUserIdWaitlistsByWaitlistIdResponse = PutV1UsersByUserIdWaitlistsByWaitlistIdResponses[keyof PutV1UsersByUserIdWaitlistsByWaitlistIdResponses];
