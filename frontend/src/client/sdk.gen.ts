...
import type {
    ...
    PostApiV1PasswordRecoveryByEmailData,
    PostApiV1PasswordRecoveryByEmailResponses,
    PostApiV1PasswordRecoveryByEmailErrors,
    ...
    GetApiV1CoursesData,
    GetApiV1CoursesResponses,
    GetApiV1CoursesErrors,
    PostApiV1CoursesData,
    PostApiV1CoursesResponses,
    PostApiV1CoursesErrors,
    DeleteApiV1CoursesByIdData,
    DeleteApiV1CoursesByIdResponses,
    DeleteApiV1CoursesByIdErrors,
    GetApiV1CoursesByIdData,
    GetApiV1CoursesByIdResponses,
    GetApiV1CoursesByIdErrors,
    PutApiV1CoursesByIdData,
    PutApiV1CoursesByIdResponses,
    PutApiV1CoursesByIdErrors,
    GetApiV1CoursesByCourseIdDocumentsData,
    GetApiV1CoursesByCourseIdDocumentsResponses,
    GetApiV1CoursesByCourseIdDocumentsErrors,
    PostApiV1DocumentsProcessData,
    PostApiV1DocumentsProcessResponses,
    PostApiV1DocumentsProcessErrors,
    GetApiV1DocumentsByIdData,
    GetApiV1DocumentsByIdResponses,
    GetApiV1DocumentsByIdErrors,
    PostApiV1PrivateUsersData,
    PostApiV1PrivateUsersResponses,
    PostApiV1PrivateUsersErrors,
    GetApiV1FlashcardsByCourseIdData, GetApiV1FlashcardsByCourseIdErrors, GetApiV1FlashcardsByCourseIdResponses
} from './types.gen';
import {
    zPostApiV1LoginAccessTokenData,
    zPostApiV1LoginAccessTokenResponse,
    zPostApiV1LoginTestTokenData,
    zPostApiV1LoginTestTokenResponse,
    zPostApiV1PasswordRecoveryByEmailData,
    zPostApiV1PasswordRecoveryByEmailResponse,
    zPostApiV1ResetPasswordData,
    zPostApiV1ResetPasswordResponse,
    zPostApiV1PasswordRecoveryHtmlContentByEmailData,
    zPostApiV1PasswordRecoveryHtmlContentByEmailResponse,
    zGetApiV1UsersData,
    zGetApiV1UsersResponse,
    zPostApiV1UsersData,
    zPostApiV1UsersResponse,
    zDeleteApiV1UsersMeData,
    zDeleteApiV1UsersMeResponse,
    zGetApiV1UsersMeData,
    zGetApiV1UsersMeResponse,
    zPatchApiV1UsersMeData,
    zPatchApiV1UsersMeResponse,
    zPatchApiV1UsersMePasswordData,
    zPatchApiV1UsersMePasswordResponse,
    zPostApiV1UsersSignupData,
    zPostApiV1UsersSignupResponse,
    zDeleteApiV1UsersByUserIdData,
    zDeleteApiV1UsersByUserIdResponse,
    zGetApiV1UsersByUserIdData,
    zGetApiV1UsersByUserIdResponse,
    zPatchApiV1UsersByUserIdData,
    zPatchApiV1UsersByUserIdResponse,
    zPostApiV1UtilsTestEmailData,
    zPostApiV1UtilsTestEmailResponse,
    zGetApiV1UtilsHealthCheckData,
    zGetApiV1UtilsHealthCheckResponse,
    zGetApiV1ItemsData,
    zGetApiV1ItemsResponse,
    zPostApiV1ItemsData,
    zPostApiV1ItemsResponse,
    zDeleteApiV1ItemsByIdData,
    zDeleteApiV1ItemsByIdResponse,
    zGetApiV1ItemsByIdData,
    zGetApiV1ItemsByIdResponse,
    zPutApiV1ItemsByIdData,
    zPutApiV1ItemsByIdResponse,
    zGetApiV1CoursesData,
    zGetApiV1CoursesResponse,
    zPostApiV1CoursesData,
    zPostApiV1CoursesResponse,
    zDeleteApiV1CoursesByIdData,
    zDeleteApiV1CoursesByIdResponse,
    zGetApiV1CoursesByIdData,
    zGetApiV1CoursesByIdResponse,
    zPutApiV1CoursesByIdData,
    zPutApiV1CoursesByIdResponse,
    zGetApiV1CoursesByCourseIdDocumentsData,
    zGetApiV1CoursesByCourseIdDocumentsResponse,
    zPostApiV1DocumentsProcessData,
    zGetApiV1DocumentsByIdData,
    zGetApiV1DocumentsByIdResponse,
    zPostApiV1PrivateUsersData,
    zPostApiV1PrivateUsersResponse,
    zGetApiV1FlashcardsByCourseIdData, zGetApiV1FlashcardsByCourseIdResponse
} from './zod.gen';
...
export class DocumentsService {
     ...
     * Accept multiple PDF uploads, create a Document record for each,
     * save to temp files, and queue a background task for each.
     */
