...
export class QuizzesService {
     ...
     */
    public static getApiV1QuizzesByQuizId<ThrowOnError extends boolean = true>(options?: Options<GetApiV1QuizzesByQuizIdData, ThrowOnError>) {
        return (options?.client ?? client).get<GetApiV1QuizzesByQuizIdResponses, unknown, ThrowOnError>({
            requestValidator: async (data) => {
                return await zGetApiV1QuizzesByQuizIdData.parseAsync(data);
            },
            responseType: 'json',
            responseValidator: async (data) => {
                return await zGetApiV1QuizzesByQuizIdResponse.parseAsync(data);
            },
            security: [
                {
                    scheme: 'bearer',
