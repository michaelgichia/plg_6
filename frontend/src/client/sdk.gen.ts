...
export class QuizSessionsService {
     ...
     */
    public static getApiV1QuizSessions<ThrowOnError extends boolean = true>(options: Options<GetApiV1QuizSessionsData, ThrowOnError>) {
        return (options.client ?? client).get<GetApiV1QuizSessionsResponses, GetApiV1QuizSessionsErrors, ThrowOnError>({
            requestValidator: async (data) => {
                return await zGetApiV1QuizSessionsData.parseAsync(data);
            },
            responseType: 'json',
            responseValidator: async (data) => {
                return await zGetApiV1QuizSessionsResponse.parseAsync(data);
            },
            security: [
                {
                    scheme: 'bearer',
